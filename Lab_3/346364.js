...
lib.ssMetadata = [
		{name:"346364_atlas_1", frames: [[0,0,1037,683]]}
];
...
(lib.карта_Минска = function() {
	this.initialize(ss["346364_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib._346364 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
// library properties:
lib.properties = {
	id: '833F20106E8B6041B056BB12D9B53602',
	width: 1920,
	height: 1080,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/346364_atlas_1.png?1677928774566", id:"346364_atlas_1"},
		{src:"sounds/Запись3onlineaudioconvertercom.mp3?1677928774584", id:"Запись3onlineaudioconvertercom"}
	],
	preloads: []
};
...
an.compositions['833F20106E8B6041B056BB12D9B53602'] = {
