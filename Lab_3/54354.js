...
lib.ssMetadata = [
		{name:"54354_atlas_1", frames: [[0,0,1037,683]]}
];
...
(lib.карта_Минска = function() {
	this.initialize(ss["54354_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib._54354 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
// library properties:
lib.properties = {
	id: '2EF2D4C75FF2D742BEB98BE52DF34B25',
	width: 1920,
	height: 1080,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/54354_atlas_1.png?1678483230896", id:"54354_atlas_1"},
		{src:"sounds/Запись3onlineaudioconvertercom.mp3?1678483230906", id:"Запись3onlineaudioconvertercom"}
	],
	preloads: []
};
...
an.compositions['2EF2D4C75FF2D742BEB98BE52DF34B25'] = {
