...
lib.ssMetadata = [
		{name:"64656_atlas_1", frames: [[0,0,1037,683]]}
];
...
(lib.карта_Минска = function() {
	this.initialize(ss["64656_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_3 = function() {
		playSound("Запись3onlineaudioconvertercom");
	}
...
// stage content:
(lib._64656 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		/* this.b1.addEventListener("click",f1.bind(this));
	...
	// Слой_1
	this.b1 = new lib.Символ2();
	this.b1.name = "b1";
	this.b1.setTransform(797,473.9);
	new cjs.ButtonHelper(this.b1, 0, 1, 2, false, new lib.Символ2(), 3);

	this.instance = new lib.Символ3();
	this.instance.setTransform(1846.35,82.75);
	new cjs.ButtonHelper(this.instance, 0, 1, 2, false, new lib.Символ3(), 3);

	this.instance_1 = new lib.Символ1();
	this.instance_1.setTransform(901.5,586.5);
	new cjs.ButtonHelper(this.instance_1, 0, 1, 2, false, new lib.Символ1(), 3);

	this.instance_2 = new lib.карта_Минска();
	this.instance_2.setTransform(0,0,1.8515,1.5813);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance},{t:this.b1}]}).wait(1));
...
// library properties:
lib.properties = {
	id: '676B96728CFE3D41BE21DDE97EC5A63E',
	width: 1920,
	height: 1080,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/64656_atlas_1.png?1677928902756", id:"64656_atlas_1"},
		{src:"sounds/Запись3onlineaudioconvertercom.mp3?1677928902775", id:"Запись3onlineaudioconvertercom"}
	],
	preloads: []
};
...
an.compositions['676B96728CFE3D41BE21DDE97EC5A63E'] = {
