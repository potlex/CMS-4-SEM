...
lib.ssMetadata = [
		{name:"_HTML5 Canvas_atlas_1", frames: [[428,0,261,140],[691,0,261,140],[428,142,261,140],[691,142,261,140],[0,298,241,140],[243,426,241,140],[486,426,241,140],[729,426,241,140],[0,156,254,140],[256,284,254,140],[512,284,254,140],[768,284,254,140],[0,0,426,154]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("ADqw3QAXAMAUAOQBwBOAABuQAABghWBIQgMAKgOAJQhvBOidAAQidAAhvhOQgCgBgCgBQhrhNAAhsQAAhuBvhOQANgJANgIQBog8CKAAQCAAABhAzQEupbK1BIAEvq5QBgBXBSCbQC8FkAAH3QAAH3i8FkQi7FkkJAAQkIAAi8lkQi7lkAAn3QAAn3C7lkQBKiMBWhVAjpwuQkupdq1BI");
...
if (reversed == null) { reversed = false; }
	...
	this.streamSoundSymbolsList[0] = [{id:"жуки",startFrame:0,endFrame:60,loop:1,offset:0},{id:"жук2v2onlineaudioconvertercom",startFrame:0,endFrame:60,loop:1,offset:0},{id:"жукonlineaudioconvertercom",startFrame:0,endFrame:61,loop:1,offset:0}];
	...
	this.frame_0 = function() {
		...
		this.InsertIntoSoundStreamData(soundInstance,0,61,1);
...
// library properties:
lib.properties = {
	id: 'C7F6CAA55DF8144CA3986D9DB9E4B202',
	width: 1920,
	height: 1080,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/_HTML5 Canvas_atlas_1.png?1677927729502", id:"_HTML5 Canvas_atlas_1"},
		{src:"sounds/жукonlineaudioconvertercom.mp3?1677927729541", id:"жукonlineaudioconvertercom"},
		{src:"sounds/жук2v2onlineaudioconvertercom.mp3?1677927729541", id:"жук2v2onlineaudioconvertercom"},
		{src:"sounds/жуки_.mp3?1677927729541", id:"жуки"}
	],
	preloads: []
};
...
an.compositions['C7F6CAA55DF8144CA3986D9DB9E4B202'] = {
